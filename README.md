...
· PostgreSQL:  Система управления базами данных для хранения данных пользователей и результатов анализов.
· RabbitMQ:  Система очередей сообщений для обработки задач и связи между компонентами.
· Flask:  Фреймворк для создания веб-приложений, используемый для создания веб-интерфейса карты больниц.

Machine Learning:

· PyTorch:  Библиотека для машинного обучения, используемая для анализа изображений (флюорография, МРТ).
· TensorFlow:  Библиотека машинного обучения, лежащая в основе Keras. 
· XGBoost:  Библиотека для машинного обучения, используемая для анализа данных и выявления заболеваний.

Frontend:

· HTML, CSS, JavaScript:  Языки веб-разработки для создания веб-приложения.

Дополнительные технологии:

· Яндекс Карты API:  API для отображения карты больниц.
· aiogram:  Асинхронная библиотека для создания ботов Telegram, обеспечивающая быструю и эффективную работу.
