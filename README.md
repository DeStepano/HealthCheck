...
· Flask:  Фреймворк для веб-приложений, используемый для создания веб-интерфейса карты больниц.
...
· Docker:  Технология контейнеризации для упрощения развертывания и управления проектом.
